<template>
  <MainContainer>
    <div class="category-page-title d-flex flex-row ga-2 align-center">
      ...
      <div>Posts in all categories</div>
    </div>
    <QueryContentList :query="query" :fromPage="`/blog/category`" :page="page" />
...
const category = ref(route.params.slug ? route.params.slug[0] : null);
console.log('/blog/category/index.vue ::', route)
