    ...
    >
      ...
      >
        <p class="footer-credit text-center">
          Powered by
          <span class="emphasis-text">Nuxt</span> &
          <span class="emphasis-text">Nuxt-Content</span>.
          Created with
          <span class="emphasis-text">Vuetify</span> &
          <span class="emphasis-text">Fontawesome</span>.
        </p>
      </div>
    </v-footer>
  </v-app>
...
:root {
  ...
  --meta-description-firstletter-color: var(
    --v-theme-baseVariant
  );
...
#navbar {
  border-bottom: 1px solid
    rgba(var(--v-theme-base), var(--heading-border-opacity));
}
